...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two Strings as arguments and sets the name as their concatenation.
     *
     * @param firstName the first part of the name of this Silly instance.
     * @param secondName the second part of the name of this Silly instance.
     */
